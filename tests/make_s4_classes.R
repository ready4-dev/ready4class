...
devtools::load_all()
make_ready_s4(name_stub = "agents",
                name_prefix = "r4test_",
...
make_ready_s4(name_stub = "lookup",
                name_prefix = "r4test_",
                output_folder = "data-raw",
...
prototype_tb <- prototype_tb %>%
  tibble::add_case(type = "r4test_lookup",
                   value = "r4test_lookup()",
                   old_class = FALSE)
make_ready_s4(name_stub = "profiled_area",
                name_prefix = "r4test_",
                output_folder = "data-raw",
...
make_ready_s4(name_stub = "sim_data",
                name_prefix = "r4test_",
                output_folder = "data-raw",
...
prototype_tb <- prototype_tb %>%
  tibble::add_case(type = c("r4test_struc"),
                   ...
                   old_class = c(FALSE))
make_ready_s4(name_stub = "struc_pert",
              name_prefix = "r4test_",
              output_folder = "data-raw",
              ...
              include_classes = c("r4test_agents","r4test_env"),
              prototype_tb = prototype_tb)
make_ready_s4(name_stub = "struc_unif",
                name_prefix = "r4test_",
                output_folder = "data-raw",
                ...
                prototype_tb = prototype_tb)
make_ready_s4(name_stub = "struc_norm",
                name_prefix = "r4test_",
                output_folder = "data-raw",
