...
classes_to_make_tb <- tibble::tribble(
  ...
  TRUE, "constructor_tbl", list("tibble"), list("is_"), list("tibble"), list(make_s3_lgl = "logical(0)",
                                                                           ...
                                                                           inc_clss_ls = "list()"), NULL, NULL, NULL, "CLASS CONSTRUCTOR TABLE Readyforwhatsnext S3 class of metadata required to make new classes.", NA_character_, NULL, NULL, NULL)
