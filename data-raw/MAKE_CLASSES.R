...
prototype_lup <- tibble::tibble(type_chr = c("character", "list", "logical", "numeric", "POSIXt", "sf","tbl_df"), ## CHANGED FROM POSIXt
                                ...
                                old_class_lgl = FALSE)
## 4. Create a table with the metadata for the ready4_class_make_tb class that we wish to create.
...
## 5. Convert the metadata table into a new S3 class called ready4_class_make_tb
