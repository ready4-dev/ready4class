validate_ready <- function(class_name,
                           parent,
  ...
  all_slots <- ready4fun::get_r4_obj_slots_chr_vec(class_name) %>% names()
  if(!is.null(parent)){
    parental_slots <- ready4fun::get_r4_obj_slots_chr_vec(parent) %>% names()
