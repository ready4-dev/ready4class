...
ready4fun::write_abbr_lup(short_name_chr = c("alg","cls","col","curr","dif","gen","gnrc","inhtc","inst","lnt","mk","mthd","ptrn",
                                             "ready4_class_make_tb","ready4_class_pt_lup",
                                             "ref","tf","tfd","unvd","val","vld","vldd"),
                            long_name_chr = c("algorithm","class","column","current","different","generate","generic","inheritance","instance","length","make","method","pattern",
