...
ready4fun::write_abbr_lup(short_name_chr = c("...","alg","cdn","chkr","cls","col","curr","dif","gen","gnrc","idx","inc","inhtc","inst","lnt","mk","mthd","ptrn",
                            ...
                            long_name_chr = c("Additional arguments","algorithm","condition","checker","class","column","current","different","generate","generic","index","include","inheritance","instance","length","make","method","pattern",
                            ...
                            no_plural_chr = c("Additional arguments","Class Constructor Table readyforwhatsnext S3 class",
