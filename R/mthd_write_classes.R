#' Write classes method applied to CLASS CONSTRUCTOR TABLE readyforwhatsnext S3 class.
#' @description write_classes.ready4_constructor_tbl() is a Write Classes method that writes new classes. This method is implemented for the CLASS CONSTRUCTOR TABLE readyforwhatsnext S3 class.NA
    ...
    class_in_cache_cdn_1L_chr = "stop", abbreviations_lup = NULL) 
{
    ...
    purrr::pwalk(x %>% dplyr::filter(make_s3_lgl == T), ~write_scripts_to_mk_r3_cls(name_stub_1L_chr = ..2, 
        ...
        vals_ls = ..6, allowed_vals_ls = ..7, min_max_vals_dbl = ..8, 
