#' ready4class function documentation table
#' 
#' Meta-data on each ready4class function used to create package documentation
#' 
#' A tibble
#' 
#' \describe{
...
#' }
#' @source \url{https://ready4-dev.github.io/ready4class/}
"fns_dmt_tb"
