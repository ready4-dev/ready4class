...
#' @param x A prototype for the ready4_class_pt_lup class, Default: make_prototype_ready4_class_pt_lup()
...
#' NA
#' @description Create a new unvalidated instance of the S3 class: ready4_class_pt_lup
#' @param x A prototype for the ready4_class_pt_lup class
...
#' NA
#' @description Create a new prototype for S3 class: ready4_class_pt_lup

#' @return A prototype for ready4_class_pt_lup class
#' @details PROTOTYPE LOOKUP Readyforwhatsnext S3 class of metadata of prototype classes.
...
#' NA
#' @description Validate an instance of the S3 class: ready4_class_pt_lup
#' @param x An unvalidated instance of the ready4_class_pt_lup class
...
x}
#' NA
#' @description Check whether an object is a valid instance of the S3 class: ready4_class_pt_lup
