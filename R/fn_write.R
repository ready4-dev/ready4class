...
#' @param slot_name_chr Slot name (a character vector)
        ...
        purrr::reduce(list(getter_ls = list(fn_name_chr = slot_name_chr, 
            ...
            .init = list(new_file_lgl = F, gnr_file = paste0(output_folder, 
                ...
                paste0(output_folder, "/gs_", slot_name_chr, 
                  ...
                  ".R"))), ~write_scripts_to_make_gnrc_and_mthd(fn_name_chr = .y[[1]], 
...
{
    required_pckg_chr_vec <- purrr::map_chr(required_pckg_chr_vec, 
        ~stringr::str_replace(.x, "NA", NA_character_))
    ignore_ns_chr <- purrr::map_chr(ignore_ns_chr, ~stringr::str_replace(.x, 
        "NA", NA_character_))
    purrr::walk(slot_names_chr_vec, ~write_slot_gtr_str_mthds(.x, 
        set_only = .x %in% set_only, parent = parent, class_name = class_name, 
...
#' @param output_dir_chr Output directory (a character vector)
#' @return NULL
...
#' @param generic_exists_lgl Generic exists (a logical vector)
...
#' @param fn_desc_chr Function description (a character vector), Default: 'NA'
#' @param fn_out_type_chr Function out type (a character vector), Default: 'NA'
#' @param fn_title_chr Function title (a character vector), Default: 'NA'
...
#' @param s3_lgl S3 (a logical vector), Default: F
#' @param write_lgl Write (a logical vector), Default: T
#' @param doc_in_class_lgl Document in class (a logical vector), Default: F
#' @return NULL
    ...
    if (!generic_exists_lgl) {
        ...
        if (write_lgl & (!file.exists(write_file_ls$gnr_file) | 
            ...
            ready4fun::write_fn_dmt(fn_name_1L_chr = fn_name_chr, 
                fn_type_1L_chr = fn_type_chr, fn = eval(parse(text = gen_mthd_pair_ls$gen_fn_chr)), 
                fn_desc_1L_chr = fn_desc_chr, fn_out_type_1L_chr = fn_out_type_chr, 
                fn_title_1L_chr = fn_title_chr, doc_in_class_1L_lgl = doc_in_class_lgl)
...
#' @param write_lgl Write (a logical vector), Default: T
#' @param append_lgl Append (a logical vector), Default: T
#' @param doc_in_class_lgl Document in class (a logical vector), Default: F
#' @return NULL
    ...
    import_chr_vec, write_lgl = T, append_lgl = T, doc_in_class_lgl = F) 
{
    ...
    if (write_lgl) {
        ...
        ready4fun::write_fn_dmt(fn_name_1L_chr = fn_name_chr, 
            fn_type_1L_chr = fn_type_chr, fn = eval(parse(text = gen_mthd_pair_ls$meth_fn_chr)), 
            fn_desc_1L_chr = fn_desc_chr, fn_out_type_1L_chr = fn_out_type_chr, 
            class_name_1L_chr = class_name_chr, import_chr = import_chr_vec, 
...
#' @param generic_exists_lgl Generic exists (a logical vector)
#' @param overwrite_lgl Overwrite (a logical vector), Default: F
#' @param s3_lgl S3 (a logical vector)
#' @param write_lgl Write (a logical vector)
#' @return NULL
    ...
    s3_lgl, write_lgl) 
{
    ...
    write_script_to_make_mthd(write_file_ls = write_file_ls, 
        gen_mthd_pair_ls = gen_mthd_pair_ls, class_name_chr = class_chr, 
        fn_name_chr = fn_name_chr, fn_type_chr = fn_type_chr_vec[2], 
        fn_desc_chr = fn_desc_chr_vec[2], fn_out_type_chr = fn_out_type_chr, 
        import_chr_vec = import_chr_vec, write_lgl = write_lgl, 
        append_lgl = append_lgl, doc_in_class_lgl = doc_in_class_lgl)
    write_file_ls
}
...
#' @param pckg_name_chr Pckg name (a character vector)
#' @param class_pfx_chr Class prefix (a character vector)
#' @param R_dir_chr R directory (a character vector), Default: 'R'
    ...
    required_pckg_chr_vec = NA_character_) 
{
    ...
    pt_lup <- make_class_pts_tb(new_classes_ls) %>% make_and_update(dev_pckg_namespace = pckg_name_chr, 
...
#' Write scripts to make readyforwhatsnext S3 classes
#' @description write_scripts_to_mk_r3_clss() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
...
#' @return NULL
#' @rdname write_scripts_to_mk_r3_clss
#' @export 
#' @importFrom purrr pwalk
    ...
    prototype_lup, ignore_ns_chr = NA_character_, file_exists_logic = "skip") 
{
    ...
    class_file_chr <- get_class_fl_nms(class_names_chr_vec = class_name, 
    ...
    if (file_exists_logic %in% c("append", "overwrite")) {
        ...
        purrr::pwalk(list(s3_components_ls$fn_name_ls, s3_components_ls$fn_text_ls, 
            ...
            ~make_lines_for_writing_dmtd_fn(fn_name = ..1, fn_text = ..2, 
...
#' Write scripts to make readyforwhatsnext S3 classes checker
#' @description write_scripts_to_mk_r3_clss_checker() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss checker.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param class_name PARAM_DESCRIPTION
...
#' Write scripts to make readyforwhatsnext S3 classes constructor
#' @description write_scripts_to_mk_r3_clss_constructor() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss constructor.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param type PARAM_DESCRIPTION
...
#' Write scripts to make readyforwhatsnext S3 classes prototypes
#' @description write_scripts_to_mk_r3_clss_pts() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss prototypes.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param type PARAM_DESCRIPTION
#' @param type_namespace PARAM_DESCRIPTION
...
#' @param prototype_lup Prototype (a lookup table)
#' @return NULL
#' @rdname write_scripts_to_mk_r3_clss_pts
#' @export 
...
#' Write scripts to make readyforwhatsnext S3 classes valid instance
#' @description write_scripts_to_mk_r3_clss_valid_instance() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss valid an instance.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param class_name PARAM_DESCRIPTION
#' @param s3_prototype PARAM_DESCRIPTION
...
#' Write scripts to make readyforwhatsnext S3 classes validator
#' @description write_scripts_to_mk_r3_clss_validator() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S3 clss validator.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param type PARAM_DESCRIPTION
#' @param class_name PARAM_DESCRIPTION
#' @param s3_prototype PARAM_DESCRIPTION
...
#' @param values PARAM_DESCRIPTION
#' @return NULL
#' @rdname write_scripts_to_mk_r3_clss_validator
#' @export 
...
#' Write scripts to make readyforwhatsnext S4 classes
#' @description write_scripts_to_mk_r4_clss() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write scripts to mk a readyforwhatsnext S4 clss.The function is called for its side effects and does not return a value. WARNING: This function writes R scripts to your local environment. Make sure to only use if you want this behaviour
#' @param name_stub PARAM_DESCRIPTION
#' @param name_prefix PARAM_DESCRIPTION, Default: 'ready4_'
#' @param output_folder PARAM_DESCRIPTION, Default: 'data-raw'
...
#' @return NULL
#' @rdname write_scripts_to_mk_r4_clss
#' @export 
#' @importFrom ready4fun close_open_sinks
    ...
    print_meaningful_names = TRUE, class_in_cache_logic_chr = "stop") 
{
    ...
    proto_ls <- make_pt_ls(class_slots = class_slots, type = type, 
        values = values, prototype_lup = prototype_lup)
    class_name <- paste0(name_prefix, name_stub)
    output_file_class <- get_class_fl_nms(class_names_chr_vec = class_name, 
    ...
    write_to_mk_r4_cls(class_name = class_name, class_slots = class_slots, 
    ...
    valid_txt <- make_alg_to_set_validity_of_r4_cls(class_name = class_name, 
        parent = parent, not_same_length = not_same_length, allowed_values = allowed_values, 
    ...
    output_folder, ignore_ns_chr, required_pckg_chr_vec) 
{
    ...
    write_gtr_str_mthds_for_r4(slot_name_chr = slot_name_chr, 
        set_only = set_only, import_packages_ls = import_packages_ls, 
        class_name = class_name, print_accessors = print_accessors, 
...
#' @param fn_title_chr Function title (a character vector)
#' @param fn_out_type_chr Function out type (a character vector)
#' @param package_chr Package (a character vector)
#' @param output_dir_chr Output directory (a character vector)
#' @param signature_chr Signature (a character vector), Default: 'NA'
#' @param append_lgl Append (a logical vector), Default: T
#' @param first_lgl First (a logical vector), Default: T
#' @return NULL
    ...
    append_lgl = T, first_lgl = T) 
{
    ...
    write_file_ls <- list(new_file_lgl = F, gnr_file = paste0(output_dir_chr, 
        ...
        "/meth_", fn_name_chr, ".R"))
    current_generics_ls <- make_ls_of_tfd_nms_of_curr_gnrcs(required_pckg_chr_vec = NA_character_, 
...
#' @param dir_chr Directory (a character vector)
#' @param pattern_chr Pattern (a character vector)
#' @return NULL
    ...
    helper_lgl = F, parent_ns_ls) 
{
    ...
    if (is.null(parent)) {
        st_class_fn <- paste0("methods::setClass(", make_alg_to_gen_ref_to_cls(class_name), 
            ",\nslots = ", slot_str, ",\nprototype =  ", proto_ls, 
            ",\nwhere =  ", "globalenv()", ")")
    }
    else {
    ...
    include_tags_chr <- make_dmt_inc_tag(included_classes_chr_vec, 
        s3_lgl = F)
    if (print_set_class) {
        ...
        writeLines(paste0(paste0("#' ", class_name, "\n"), paste0("#' @name ", 
            ...
            class_desc, "\n", include_tags_chr, old_class_tb_extension %>% 
                ...
                "globalenv\\(\\)"), "") %>% transform_alg_to_ref_cls_nm(package_chr = ifelse(is.null(parent), 
