    ...
    server_1L_chr = Sys.getenv("DATAVERSE_SERVER")) 
{
    ...
    x$pkg_setup_r3$subsequent_ls$cls_fn_ls <- ready4fun::make_pt_ready4fun_fn_ls(args_ls = list(x = x$constructor_tbl_r3, 
        ...
        name_pfx_1L_chr = paste0(x$initial_ls$pkg_desc_ls$Package, 
            "_"), output_dir_1L_chr = paste0(x$initial_ls$path_to_pkg_rt_1L_chr, 
        ...
        object_type_lup = x$subsequent_ls$object_type_lup), fn = author.ready4class_constructor_tbl) %>% 
